...
try: 
    audio = generate(text="Hey Rodrigo, have you heard about W3Schools and their free online tutorials in all major web languages?", voice="Rachel", model="eleven_monolingual_v1")
    with open("pcaso.mp3", "wb") as f:
        f.write(audio)
except Exception as e:
    logging.exception(e)
    print("error")
